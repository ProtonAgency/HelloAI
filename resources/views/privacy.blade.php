        ...
        <div class="col-sm-12">
            ...
            <div class="accordion-box">
                <div class="accordion">
                    ...
                    <div>
                        <p>When you create an account with our service, as part of our service's process, we collect the personal information you give us such as your name, address and email address and/or billing information.<br>
                ...
                <div class="accordion">
                    ...
                    <div>
                        ...
                        If after you opt-in, you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use or disclosure of your information, at anytime, by contacting us at sales@lynndigital.com</p>
                    </div>
                </div>
                <div class="accordion">
                    <div>
                ...
                <div class="accordion">
                    ...
                    <div>
                        <p>Your data is stored through HelloForms's data storage, databases and the general HelloForms application. We store your data on a secure server behind a firewall. Sensitive data (credit card information) is stored by a third party on a secure server behind a firewall.<br><br>
                ...
                <div class="accordion">
                    ...
                    <div>
                        ...
                        If you provide us with your credit card information, the information is encrypted using secure socket layer technology (SSL) and stored with a AES-256 encryption by a third party. Although no method of transmission over the Internet or electronic storage is 100% secure, we follow PCI-DSS requirements and implement additional generally accepted industry standards.</p>
                    </div>
                </div>
                <div class="accordion">
                    <div>
                    ...
                    <div>
                        ...
                        If our company is acquired or merged with another company, your information may be transferred to the new owners so that we may continue to provide our service to you.</p>
                    </div>
                </div>
                <div class="accordion">
                    <div>
                    ...
                    <div>
                        <p>If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint, or simply want more information contact our Privacy Compliance Officer at sales@lynndigital.com.</p>
                    </div>
                </div>
            </div>
        </div>
